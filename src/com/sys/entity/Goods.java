...
public class Goods implements Serializable {
    private static final long serialVersionUID = -6405216716538176249L;
    ...
    public Goods(String goodsId, String goodsName, String goodsUnit, String goodsType, String goodsColor, Integer goodsStore, Integer goodsLimit, BigDecimal goodsCommission, String goodsProducer, String goodsRemark, BigDecimal goodsSelPrice, BigDecimal goodsBuyPrice) {
        this.goodsId = goodsId;
        this.goodsName = goodsName;
        this.goodsUnit = goodsUnit;
        this.goodsType = goodsType;
