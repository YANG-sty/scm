...
<body>
    <form id="ff" method="post">
        <div>
            <label for="sysParamId">参数编号：</label>
            <input type="text" name="sysParamId" readonly="readonly"/>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#ff').form('load',{
                ...
                sysParamField:row.sysParamField,
                sysParamValue:row.sysParamValue,
                sysParamText:row.sysParamText,
                sysParamType:row.sysParamType
            });
            ...
            $("#btn").click(function () {
                ...
                if($("#ff").form("validate")){
                    $('#ff').form('submit',{
                        url : '${proPath}/sysParam/update.action',
                        onSubmit : function () {
                            return true;
                        },
